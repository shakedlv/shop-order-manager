...
function MultiSelectDropdown({ array, parameter, id, placeholder, onSelectEvent }) {
    ...
    return (
        <div className="max-w-md w-36 min-w-[128px] border border-neutral-300 rounded-md h-10 p-2 px-3 cursor-pointer "
